...
namespace Tangy_DataAccess.Migrations
{
    ...
    [Migration("20240310145237_blogintro")]
    partial class blogintro
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tangy_DataAccess.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tangy_DataAccess.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tangy_DataAccess.Import", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tangy_DataAccess.Comment", b =>
                {
                    ...
                    b.HasOne("Tangy_DataAccess.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
